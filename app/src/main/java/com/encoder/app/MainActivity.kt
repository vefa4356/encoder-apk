...
class MainActivity : Activity() {
    ...
    private val KURULUM_FLAG = "kuruldu_v5.flag"
        ...
        Thread {
            try {
                ...
                val env = arrayOf(
                    ...
                    "LD_LIBRARY_PATH=${assetsDir.absolutePath}:$nativeDir:/data/data/com.termux/files/usr/lib:${System.getenv("LD_LIBRARY_PATH") ?: ""}"
                )
